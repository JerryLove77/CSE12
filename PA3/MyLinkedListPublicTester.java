 ...
 * @author Jianwei Gong
 * Date: 04/8/2022
 * Description: This is the public tester file for PA3. 
 * It contains test cases for the MyLinkedList and Node classes.
 */
...
/**
 * This class contains public test cases that ensure basic functionality of
 * MyLinkList. 
 */
public class MyLinkedListPublicTester {
    ...
    public void testIsEmpty() {
        ...
        assertFalse("A list with 3 elements should not be empty", 
            ...
            assertTrue("A list no element should be empty", 
