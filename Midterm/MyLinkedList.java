 ...
 * File description: 
 * Several methods and constructor about LinkedList
 * and work for reverse method.
 */

/**
 * Implementation of MyReverseList. Several methods 
 * and constructor about LinkedList and work for reverse method.
 */
public class MyLinkedList<E> implements MyReverseList<E>{
     ...
     * rever the region from fromIndex to toIndex of LinkedList
     */
    public void reverseRegion(int fromIndex, int toIndex){
        ...
        if(fromIndex < toIndex){
            for(int i = 0; i <= (toIndex-fromIndex)/2; i++){
                Object temp = getNth(fromIndex+i).getElement();
                getNth(fromIndex+i).setElement(getNth(toIndex-i).getElement());
                getNth(toIndex-i).setElement((E) temp);
