 ...
 * Sources used: None 
 * 
 * Abstract class of RPS. It works by provinding final strings,
 * checking whether it is a valid move and several 
 */
...
/**
 *  class header 
 *  An abstract class that implements isValidMove,play, genCPU, 
 *  and end methods in RPSInterface
 */
