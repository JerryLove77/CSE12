 ...
 * Sources used: None
 * 
 * This file contains Ticket class which implements Comparable<Ticket>
 * This file is used to simulate the autograder system
 */
...
public class Ticket implements Comparable<Ticket>{
	 ...
	 * whether this Ticket comes before the other Ticket or not
	 * @param other (the Ticket object will be compared)
	 * @return (negative value, 0, positive value)
	 */
	@Override
	public int compareTo(Ticket other){
		int thistype = this.orderMap.get(this.getTicketType());
		int othertype = other.orderMap.get(other.getTicketType());
